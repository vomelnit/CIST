...
@app.route('/smark')
def smark():
   mycursor.execute('SELECT * FROM smark')
   data = mycursor.fetchall()
...
def scontract_kind():
   mycursor.execute('SELECT * FROM scontract_kind')
   data = mycursor.fetchall()
...
def speciality():
   mycursor.execute('SELECT * FROM speciality')
   data = mycursor.fetchall()
